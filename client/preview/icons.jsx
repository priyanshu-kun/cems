// Preview icons (mirrors src/components/Icon.jsx exactly)
function Icon({ name, size = 24, color = "currentColor", strokeWidth = 2, className }) {
  const p = { width: size, height: size, viewBox: "0 0 24 24", fill: "none",
    stroke: color, strokeWidth, strokeLinecap: "round", strokeLinejoin: "round", className };
  switch (name) {
